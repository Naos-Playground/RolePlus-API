// -----------------------------------------------------------------------
// <copyright file="RoleBehaviour.cs" company="NaoUnderscore">
...
namespace RolePlus.ExternModule.API.Features.CustomRoles
{
    ...
    /// </summary>
    public abstract class RoleBehaviour : EBehaviour, IAddittiveSettings<RoleSettings>
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="RoleType"/> of the fake appearance applied by this <see cref="RoleBehaviour"/> component.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a <see cref="IEnumerable{T}"/> of <see cref="EffectType"/> which should be given to the player.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the <see cref="EBehaviour.Owner"/> has the night vision enabled.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="RoleType"/> of this <see cref="RoleBehaviour"/> component.
        /// </summary>
        ...
        /// <summary>
        /// Fired upon the third person mesh generation.
        /// </summary>
        /// <param name="meshName">The name of the mesh.</param>
        /// <param name="objectName">The object name.</param>
        /// <param name="transform">The mesh <see cref="FTransform"/>.</param>
        /// <param name="fixedTickRate">The fixed tick rate to be used along with the mesh component.</param>
        ...
        /// <summary>
        /// Fired when the third person mesh is destroyed.
        /// </summary>
