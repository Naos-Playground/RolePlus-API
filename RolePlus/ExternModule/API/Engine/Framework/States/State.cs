// -----------------------------------------------------------------------
// <copyright file="State.cs" company="NaoUnderscore">
...
namespace RolePlus.ExternModule.API.Engine.Framework.States
{
    ...
    public abstract class State : EActor, IState
    {
        ...
        private readonly HashSet<StateController> _controllers = new();
        private readonly HashSet<StateController> _activeControllers = new();
        private readonly HashSet<StateController> _inactiveControllers = new();
        ...
        /// </summary>
        public IEnumerable<StateController> Controllers => _controllers;

        /// <summary>
        /// Gets all the <see cref="StateController"/>s running on this <see cref="State"/>.
        /// </summary>
        public IEnumerable<StateController> ActiveControllers => _activeControllers;

        /// <summary>
        /// Gets all the <see cref="StateController"/>s running on a <see cref="State"/> other than this.
        /// </summary>
        public IEnumerable<StateController> InactiveControllers => _inactiveControllers;
        ...
        public virtual void OnEnter(StateController stateController)
        {
            ...
            _activeControllers.Add(stateController);
            _inactiveControllers.Remove(stateController);
        }
        ...
        public virtual void OnExit(StateController stateController)
        {
            ...
            _inactiveControllers.Add(stateController);
            _activeControllers.Remove(stateController);
        }
