...
namespace RolePlus.ExternModule.Events.DynamicEvents
{
    ...
    public class DynamicEventDispatcher : TypeCastObject<DynamicEventDispatcher>, IDynamicEventDispatcher
    {
        ...
        public DynamicEventDispatcher(Dictionary<object, List<Action>> delegates) => _boundDelegates = delegates;
        ...
        public KeyValuePair<object, List<Action>> this[object @object] => _boundDelegates.FirstOrDefault(kvp => kvp.Key == @object);
        ...
        /// </summary>
        /// <param name="left">The <see cref="TDynamicEventDispatcher{T}"/> to bind the listener from.</param>
        ...
        /// </summary>
        /// <param name="left">The <see cref="TDynamicEventDispatcher{T}"/> to bind the listeners from.</param>
